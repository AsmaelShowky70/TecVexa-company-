      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <div className="p-6 sm:p-8 rounded-3xl bg-gradient-to-br from-emerald-600 to-teal-700 dark:from-emerald-950/60 dark:to-slate-900 border-2 border-emerald-500/50 shadow-xl shadow-emerald-500/15 space-y-4 sm:space-y-5 text-white">
              <div className="w-12 h-12 sm:w-14 sm:h-14 rounded-2xl bg-white/20 dark:bg-emerald-500/20 border border-white/30 dark:border-emerald-500/30 flex items-center justify-center text-white dark:text-emerald-400 shrink-0">
              ...
              <div>
                ...
                <p className="mt-1 text-xs sm:text-sm text-emerald-100 dark:text-slate-300 leading-relaxed">
                  {isRtl 
              ...
              <div className="p-3.5 sm:p-4 rounded-2xl bg-black/20 dark:bg-slate-950/80 border border-white/20 dark:border-slate-800 flex items-center justify-between gap-2">
                <div>
                  <span className="text-[10px] sm:text-[11px] uppercase font-bold text-emerald-100 dark:text-slate-400 block">
                    {t.contact.phoneLabel}
                  </span>
                  <span className="text-base sm:text-lg font-black text-white dark:text-emerald-400 font-mono" dir="ltr">
                    {t.contact.whatsAppNumber}
                  </span>
                </div>
                <div className="flex items-center gap-1.5 text-xs text-white dark:text-emerald-400 font-bold shrink-0">
              ...
              <button
                ...
                className="w-full py-3.5 sm:py-4 px-6 rounded-xl font-extrabold text-sm sm:text-base text-slate-950 bg-white hover:bg-slate-100 dark:bg-gradient-to-r dark:from-emerald-400 dark:to-teal-400 shadow-xl shadow-emerald-500/20 transition-all flex items-center justify-center gap-2 hover:scale-105 active:scale-95"
              >
            ...
            <div className="p-5 sm:p-6 rounded-3xl glass-card border border-slate-200 dark:border-slate-800 space-y-4 text-xs sm:text-sm shadow-sm">
          ...
          <div className="lg:col-span-7">
            <div className="p-5 sm:p-8 md:p-10 rounded-3xl glass-card border border-slate-200 dark:border-slate-700 shadow-xl relative">
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  <div>
                    ...
                    <input
                      ...
                      className="w-full py-3 px-4 rounded-xl bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700 text-slate-900 dark:text-white text-base sm:text-sm focus:outline-none focus:border-cyan-500 shadow-sm"
                    />
                  </div>
                ...
                <div>
                  ...
                  <textarea
                    ...
                    className="w-full py-3 px-4 rounded-xl bg-white dark:bg-slate-900 border border-slate-300 dark:border-slate-700 text-slate-900 dark:text-white text-base sm:text-sm focus:outline-none focus:border-cyan-500 resize-none shadow-sm"
                  ></textarea>
                </div>
                ...
                <button
                  ...
                  className="w-full py-3.5 sm:py-4 px-6 rounded-xl font-extrabold text-sm sm:text-base text-slate-950 bg-gradient-to-r from-cyan-400 via-teal-400 to-emerald-400 hover:opacity-95 shadow-xl shadow-cyan-500/20 transition-all flex items-center justify-center gap-2 hover:scale-[1.02] active:scale-95 disabled:opacity-50"
                >
                  {isSubmitting ? (
